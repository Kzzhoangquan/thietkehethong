...
def extract_gap_sequences(video_path, num_frames=8, gap=8, start_frame=1):
...
def predictcamera():
    try:
        ...
        sequences = extract_gap_sequences(mau_obj.videopath, num_frames=8, gap=8, start_frame=1)
        if not sequences:
